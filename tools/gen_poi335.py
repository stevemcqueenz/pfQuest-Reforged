...
Phase B of the pins work: the data half. Consumers are compass.lua (tracking
mirror + ambient markers), pins.lua (extras) and waypoint.lua (/way <class>).
...
-- hand-edit. Phase B of the pins work: consumed by compass.lua (tracking
-- mirror + ambient markers), pins.lua (extras) and waypoint.lua (/way).
--
