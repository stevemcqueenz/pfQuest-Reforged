...
--
-- 10749 nodes across 42 objects, 26 units and 22 zones
-- by track: chests 29, fish 544, herbs 2880, mines 7195, rares 101
-- skipped: 18321 on Azeroth (out of scope), 4238 already covered by pfQuest in that zone, 0 in a zone pfQuest has no rectangle for, 0 outside every fitted zone, 13 off the fitted map, 0 in a zone with no pfDB.minimap size, 216 duplicates
pfDB["tracking335"] = {
  ["objects"] = {
    ["coords"] = {
      [324] = {
