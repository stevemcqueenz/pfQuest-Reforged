...
--
-- 9960 nodes across 36 objects, 26 units and 19 zones
-- by track: chests 29, fish 540, herbs 2524, mines 6768, rares 99
-- skipped: 18802 on Azeroth (out of scope), 3926 already covered by pfQuest in that zone, 620 in a zone pfQuest has no rectangle for, 0 outside every fitted zone, 13 off the fitted map, 0 in a zone with no pfDB.minimap size, 216 duplicates
pfDB["tracking335"] = {
  ["objects"] = {
    ["coords"] = {
      [1732] = {
